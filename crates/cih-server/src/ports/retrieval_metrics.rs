...
pub(crate) struct SearchRuntimeMetricsSnapshot {
    ...
    pub(crate) semantic_attempted: u64,
    pub(crate) semantic_succeeded: u64,
    pub(crate) semantic_failed: u64,
    pub(crate) semantic_timed_out: u64,
    pub(crate) semantic_rejected: u64,
    pub(crate) semantic_elapsed_ms: u64,
