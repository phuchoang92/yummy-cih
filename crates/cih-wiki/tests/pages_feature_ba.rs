...
fn has_correct_frontmatter() {
    ...
    let md = render_feature_ba("order", &ids, &g, None, None, None, None);
...
fn includes_process_overview_when_llm_present() {
    ...
    let md = render_feature_ba("order", &ids, &g, Some(&sums), None, None, None);
...
fn renders_feature_level_summary_when_present() {
    ...
    let md = render_feature_ba("order", &ids, &g, None, None, Some(&feature), None);
